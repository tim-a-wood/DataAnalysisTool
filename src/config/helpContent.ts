export const helpSections = [
  { title: "Workbook Format", body: "Load an XLSX workbook using the Import XLSX button. The workbook must contain a Data sheet with a Case column. Optional Groups and Variables sheets can configure the tool. If those sheets are missing, Dataset Analyzer uses the built-in aircraft performance template." },
